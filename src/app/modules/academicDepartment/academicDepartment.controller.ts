...
import { academicDepartmentFilterAbleFields } from './academicDepartment.contents';
...
const getAllFromDbController = catchAsync(
  async (req: Request, res: Response) => {
    ...
    const result = await AcademicDepartmentServices.getAllFromDb(filter, options);
...
const getDataByIDController = catchAsync(
  async (req: Request, res: Response) => {
    ...
    const result = await AcademicDepartmentServices.getDataByID(id);
...
const updateDataController = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await AcademicDepartmentServices.UpdateData(id, payload);
...
const deleteDataController = catchAsync(
  async (req: Request, res: Response) => {
    ...
    const result = await AcademicDepartmentServices.deleteData(id);
